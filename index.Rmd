...
### <span style="font-size: 22px; font-weight: bold;">**How does maternal age vary based on whether they experienced full term, early term, or preterm birth? How do these distributions vary by maternal BMI category?**</span> {.no-padding}
...
### <span style="font-size: 22px; font-weight: bold;">How does the percentage of full term, early term, and preterm birth vary based on maternal educational level?</span> {.no-padding}
```{r, widget2}
